...
const { BUYING_SMARTSUITE } = require("../../../Shared/src/shared/smartsuite/config");
...
function buildListingCandidates(rawRecords) {
  ...
  return normalized.map((record, index) => {
    ...
    return {
      ...record,
      raw_record: raw,
      platform_listed_on_labels: unwrapLabels(raw[BUYING_SMARTSUITE.fields.platformListedOn]),
    };
  });
}
