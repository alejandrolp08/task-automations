...
function buildDateTokens(eventDate) {
  ...
  return Array.from(
    ...
    `${monthShort} ${day}, ${year}`,
    `${monthLong} ${day}, ${year}`,
    `${monthShortEs} ${day}, ${year}`,
    `${monthLongEs} ${day}, ${year}`,
    `${monthShort} ${paddedDay}, ${year}`,
    `${monthLong} ${paddedDay}, ${year}`,
    `${monthShortEs} ${paddedDay}, ${year}`,
    `${monthLongEs} ${paddedDay}, ${year}`,
    `${monthShort} ${day}`,
    `${monthLong} ${day}`,
    `${monthShortEs} ${day}`,
    `${monthLongEs} ${day}`,
    ...
    `${monthLong} ${paddedDay}`,
    `${monthShortEs} ${paddedDay}`,
    `${monthLongEs} ${paddedDay}`,
    `${day} ${monthShort} ${year}`,
    `${day} ${monthLong} ${year}`,
    `${day} ${monthShortEs} ${year}`,
    `${day} ${monthLongEs} ${year}`,
    `${paddedDay} ${monthShort} ${year}`,
    `${paddedDay} ${monthLong} ${year}`,
    `${paddedDay} ${monthShortEs} ${year}`,
    `${paddedDay} ${monthLongEs} ${year}`,
    `${day} ${monthShort}`,
    `${day} ${monthLong}`,
    `${day} ${monthShortEs}`,
    `${day} ${monthLongEs}`,
    ...
    `${paddedDay} ${monthLong}`,
    `${paddedDay} ${monthShortEs}`,
    `${paddedDay} ${monthLongEs}`,
